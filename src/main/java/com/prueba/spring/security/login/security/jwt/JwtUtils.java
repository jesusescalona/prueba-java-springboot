package com.prueba.spring.security.login.security.jwt;
...
public class JwtUtils {
  ...
  @Value("${prueba.app.jwtExpirationMs}")
  private int jwtExpirationMs;

  @Value("${prueba.app.jwtCookieName}")
  ...
  public boolean validateJwtToken(String authToken) {
    try {
      ...
      logger.error("JWT indica que existe una cadena vacia: {}", e.getMessage());
    }
